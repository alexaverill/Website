...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	...
	value:`,o)}addColor(t,e,n=1){return new Wm(this,t,e,n)}addFolder(t){const e=new ca({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof ks||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof ks)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const r=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=r+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}class Gr extends ae{constructor(){const t=Gr.SkyShader,e=new en({name:t.name,uniforms:vl.clone(t.uniforms),vertexShader:t.vertexShader,fragmentShader:t.fragmentShader,side:Me,depthWrite:!1});super(new Tn(1,1,1),e),this.isSky=!0}}Gr.SkyShader={name:"SkyShader",uniforms:{turbidity:{value:2},rayleigh:{value:1},mieCoefficient:{value:.005},mieDirectionalG:{value:.8},sunPosition:{value:new P},up:{value:new P(0,1,0)}},vertexShader:`
		...
		}`};const Ti=(i,t,e,n,r)=>{i.add(t,"x").min(e).max(n).step(r),i.add(t,"y").min(e).max(n).step(r),i.add(t,"z").min(e).max(n).step(r)},Pi=(i,t,e=-10,n=10,r=.1)=>{let s=i.addFolder("Position");Ti(s,t.position,e,n,r);let o=i.addFolder("Rotation");Ti(o,t.rotation,e,n,r)},jt=new Rm;let Pl=jt.load("./door/color.WEBP");Pl.colorSpace=me;let Km=jt.load("./door/ambientOcclusion.WEBP"),Zm=jt.load("./door/alpha.WEBP"),Jm=jt.load("./door/height.WEBP"),Qm=jt.load("./door/metalness.WEBP"),tg=jt.load("./door/normal.WEBP"),eg=jt.load("./door/roughness.WEBP"),ng=jt.load("./floor/alpha.WEBP"),tr=jt.load("./floor/park_dirt_1k/park_dirt_diff_1k.WEBP"),Wr=jt.load("./floor/park_dirt_1k/park_dirt_nor_gl_1k.WEBP"),Xr=jt.load("./floor/park_dirt_1k/park_dirt_disp_1k.WEBP"),vi=jt.load("./floor/park_dirt_1k/park_dirt_arm_1k.WEBP"),Sn=8;tr.repeat.set(Sn,Sn);tr.wrapS=Ht;tr.wrapT=Ht;tr.colorSpace=me;Wr.repeat.set(Sn,Sn);Wr.wrapS=Ht;Wr.wrapT=Ht;Xr.repeat.set(Sn,Sn);Xr.wrapS=Ht;Xr.wrapT=Ht;vi.repeat.set(Sn,Sn);vi.wrapS=Ht;vi.wrapT=Ht;let er=jt.load("./walls/stone_brick_wall_001_diff_1k.WEBP");er.colorSpace=me;let ha=jt.load("./walls/stone_brick_wall_001_disp_1k.WEBP"),Yr=jt.load("./walls/stone_brick_wall_001_nor_gl_1k.WEBP"),xi=jt.load("./walls/stone_brick_wall_001_arm_1k.WEBP"),En=1;er.repeat.set(En,En);ha.repeat.set(En,En);Yr.repeat.set(En,En);xi.repeat.set(En,En);er.wrapS=Ht;er.wrapT=Ht;ha.wrapS=Ht;ha.wrapT=Ht;Yr.wrapS=Ht;Yr.wrapT=Ht;xi.wrapS=Ht;xi.wrapT=Ht;let Li=jt.load("./roof/roof_slates_02_diff_1k.WEBP");Li.colorSpace=me;let zn=jt.load("./roof/roof_slates_02_arm_1k.WEBP"),qr=jt.load("./roof/roof_slates_02_disp_1k.WEBP"),nr=jt.load("./roof/roof_slates_02_nor_gl_1k.WEBP"),$r=0;Li.rotation=$r;zn.rotation=$r;qr.rotation=$r;nr.rotation=$r;let jr=3;Li.repeat.set(jr,1);qr.repeat.set(jr,1);nr.repeat.set(jr,1);zn.repeat.set(jr,1);Li.wrapS=Ht;Li.wrapT=Ht;qr.wrapS=Ht;qr.wrapT=Ht;nr.wrapS=Ht;nr.wrapT=Ht;zn.wrapS=Ht;zn.wrapT=Ht;let ir=jt.load("./bush/leaves_forest_ground_diff_1k.WEBP");ir.colorSpace=me;let Kr=jt.load("./bush/leaves_forest_ground_disp_1k.WEBP"),Zr=jt.load("./bush/leaves_forest_ground_nor_gl_1k.WEBP"),Mi=jt.load("./bush/leaves_forest_ground_arm_1k.WEBP"),Jr=6,Qr=1;ir.repeat.set(Jr,Qr);ir.wrapS=Ht;ir.wrapT=Ht;Kr.repeat.set(Jr,Qr);Kr.wrapS=Ht;Kr.wrapT=Ht;Zr.repeat.set(Jr,Qr);Zr.wrapS=Ht;Zr.wrapT=Ht;Mi.repeat.set(Jr,Qr);Mi.wrapS=Ht;Mi.wrapT=Ht;let ua=jt.load("./grave/rock_05_diff_1k.WEBP");ua.colorSpace=me;let Ll=jt.load("./grave/rock_05_nor_gl_1k.WEBP"),Dl=.3,Il=.4;ua.repeat.set(Dl,Il);Ll.repeat.set(Dl,Il);const Oe=new ca({closeFolders:!0}),Ul=document.querySelector("canvas.webgl"),Le=new Am;let nn={ambientColor:"#84b6e2#",directionalColor:"#6198e9",pointLightColor:"#e94f19"};const Nl=new Dm(nn.ambientColor,.1);Le.add(Nl);const De=new Lm(nn.directionalColor,2);De.position.set(3,2,-8);Le.add(De);let Fl=Oe.addFolder("Lights");Fl.addColor(nn,"ambientColor").name("Ambient Color").onChange(i=>{Nl.color.set(nn.ambientColor)});Fl.addColor(nn,"ambientColor").name("Directional Color").onChange(i=>{De.color.set(nn.directionalColor)});let Di=new kr(nn.pointLightColor,9);Di.position.set(.3,3.4,4);new Im(Di);Le.add(Di);let da=Oe.addFolder("Point Light");Pi(da,Di,-10,10,.01);da.addColor(nn,"pointLightColor").name("Ambient Color").onChange(i=>{Di.color.set(nn.pointLightColor)});da.add(Di,"intensity").min(1).max(100).step(.01);let Ii=new kr("#ff0000",9),Ui=new kr("#ff00ff",9),Ni=new kr("#f000ff",9);Le.add(Ii,Ui,Ni);const ze={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{ze.width=window.innerWidth,ze.height=window.innerHeight,yn.aspect=ze.width/ze.height,yn.updateProjectionMatrix(),kn.setSize(ze.width,ze.height),kn.setPixelRatio(Math.min(window.devicePixelRatio,2))});const yn=new Te(75,ze.width/ze.height,.1,100);yn.position.x=4;yn.position.y=2;yn.position.z=10;Le.add(yn);const Ol=new Nm(yn,Ul);Ol.enableDamping=!0;const kn=new ym({canvas:Ul});kn.setSize(ze.width,ze.height);kn.setPixelRatio(Math.min(window.devicePixelRatio,2));let ig=new wi(20,20,100,100),bn=new ae(ig,new Ci({alphaMap:ng,transparent:!0,map:tr,normalMap:Wr,displacementMap:Xr,aoMap:vi,roughnessMap:vi,metalnessMap:vi,displacementScale:.7,displacementBias:-.2}));Oe.add(bn.material,"displacementScale").min(0).max(1).step(.001);Oe.add(bn.material,"displacementBias").min(-1).max(1).step(.001);bn.rotation.x=-Math.PI*.5;bn.position.y=0;let Bl=Oe.addFolder("Base Plane"),rg=Bl.addFolder("Position");Ti(rg,bn.position,-11,30,.1);let sg=Bl.addFolder("Plane Scale");Ti(sg,bn.scale,1,30,.1);Le.add(bn);let ts=new pi;Le.add(ts);let ag=new Tn(6,4,6),es=new ae(ag,new Ci({map:er,aoMap:xi,normalMap:Yr,roughnessMap:xi,metalnessMap:xi}));es.position.y=2;ts.add(es);let Wn=new ae(new aa(4.75,2,4),new Ci({map:Li,normalMap:nr,aoMap:zn,roughnessMap:zn,metalnessMap:zn}));Wn.position.y=5;Wn.rotation.y=Math.PI*.25;let zl=Oe.addFolder("Roof"),og=zl.addFolder("Position");Ti(og,Wn.position,-10,10,.1);let lg=zl.addFolder("Rotation");Ti(lg,Wn.rotation,-Math.PI,Math.PI,.1);ts.add(Wn);let fa=new ae(new wi(3,3,25,25),new Ci({map:Pl,transparent:!0,alphaMap:Zm,aoMap:Km,displacementMap:Jm,metalnessMap:Qm,normalMap:tg,roughnessMap:eg,displacementScale:.1,displacementBias:-.04}));fa.position.set(0,1.4,3.01);let cg=Oe.addFolder("Door");Pi(cg,fa);ts.add(fa);let ns=new Vr(1),is=new Ci({map:ir,aoMap:Mi,roughnessMap:Mi,metalnessMap:Mi,normalMap:Zr,displacementMap:Kr,displacementScale:.5}),rr=new ae(ns,is);rr.position.set(2,.4,3.5);rr.scale.setScalar(.5);rr.rotation.x=-.9;let hg=Oe.addFolder("Bush 1");Pi(hg,rr,-10,20,.1);let sr=new ae(ns,is);sr.position.set(-2,.4,3.5);sr.scale.setScalar(.75);sr.rotation.x=-.75;let ug=Oe.addFolder("Bush 2");Pi(ug,sr,-10,20,.1);let ar=new ae(ns,is);ar.position.set(-3.2,.4,3.5);ar.scale.setScalar(.4);ar.rotation.x=-.75;let dg=Oe.addFolder("Bush 3");Pi(dg,ar,-10,20,.1);let Xn=new ae(ns,is);Xn.position.set(5,.5,-3);Xn.scale.setScalar(.5);Xn.rotation.x=-.75;let fg=Oe.addFolder("Bush 4");Pi(fg,Xn,-10,20,.1);Le.add(rr,sr,ar,Xn);let pg=new Tn(.6,.85,.15),mg=new Ci({color:"#cacaca",map:ua,normalMap:Ll}),Hl=new pi;Le.add(Hl);for(let i=0;i<30;i++){let t=new ae(pg,mg),e=Math.random()*Math.PI*2,n=4+Math.random()*4,r=Math.sin(e)*n,s=Math.cos(e)*n;t.rotation.x=-.2+Math.random()*.4,t.rotation.y=-.2+Math.random()*.4,t.rotation.z=-.2+Math.random()*.4,t.position.set(r,Math.random()*.4,s),t.castShadow=!0,t.receiveShadow=!0,Hl.add(t)}kn.shadowMap.enabled=!0;kn.shadowMap.type=Zo;Ii.castShadow=!0;Ui.castShadow=!0;Ni.castShadow=!0;De.castShadow=!0;bn.receiveShadow=!0;es.receiveShadow=!0;es.castShadow=!0;Wn.receiveShadow=!0;Wn.castShadow=!0;Xn.castShadow=!0;Xn.receiveShadow=!0;De.shadow.mapSize.width=256;De.shadow.mapSize.height=256;De.shadow.camera.top=8;De.shadow.camera.right=8;De.shadow.camera.bottom=-8;De.shadow.camera.left=-8;De.shadow.camera.near=1;De.shadow.camera.far=20;Ii.shadow.mapSize.width=256;Ii.shadow.mapSize.height=256;Ii.shadow.camera.far=10;Ui.shadow.mapSize.width=256;Ui.shadow.mapSize.height=256;Ui.shadow.camera.far=10;Ni.shadow.mapSize.width=256;Ni.shadow.mapSize.height=256;Ni.shadow.camera.far=10;const Yn=new Gr;Yn.scale.set(100,100,100);Yn.material.uniforms.turbidity.value=10;Yn.material.uniforms.rayleigh.value=3;Yn.material.uniforms.mieCoefficient.value=.1;Yn.material.uniforms.mieDirectionalG.value=.95;Yn.material.uniforms.sunPosition.value.set(.3,-.038,-.95);Le.add(Yn);Le.fog=new ra("#04343f",.1);const jo=new Fm;let Vl=Math.random()*8,kl=Math.random()*7,Gl=Math.random()*9;console.log(Vl);console.log(kl);console.log(Gl);const Gs=(i,t,e)=>{let n=e*Math.PI*2/10;t.position.x=Math.cos(n)*i,t.position.z=Math.sin(n)*i,t.position.y=Math.sin(e)*Math.sin(e)*Math.sin(e)},Wl=()=>{jo.update();const i=jo.getElapsed();Gs(Vl,Ii,i),Gs(kl,Ui,-i),Gs(Gl,Ni,-i*1.2),Ol.update(),kn.render(Le,yn),window.requestAnimationFrame(Wl)};Wl();
//# sourceMappingURL=index-CRzEWIOK.js.map
